<?php
// Include the functions from the lib folder
require 'lib/ReadText.php';
require 'lib/ReadCSV.php';
require 'lib/ReadJSON.php';

// Paths to the data files
$TextPath = 'data/companyText.txt';
$csvFilePath = 'data/companyInformation.csv';
$jsonFilePath = 'data/complexInformation.json';

// Read the data
$Text = ReadText($TextPath);
$CSV = ReadCSV($csvFilePath);
$JSON = ReadJSON($jsonFilePath);
?>
